    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-950">
      ...
      >
        ...
        <div className="p-2 sm:p-4 border-b border-gray-200 dark:border-gray-700">
          <Button
            onClick={() => {}}
            className="w-full justify-start bg-blue-600 hover:bg-blue-700 text-white h-8 sm:h-10 text-sm"
          >
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 p-2 sm:p-4">
          {loading ? (
            ...
            <p className="text-center text-gray-500 dark:text-gray-400">Failed to load user data.</p>
          )}
        </div>
      </div>
            ...
            {[].length === 0 ? (
              <div className="flex items-center justify-center h-full">
                <div className="text-center max-w-md px-4">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:grid-cols-1 sm:gap-4">
                    {[
                      { text: "Help me write an email", icon: Mail },
                      { text: "Explain a complex topic", icon: BookOpen },
                      { text: "Brainstorm creative ideas", icon: Lightbulb },
                      ...
                      return (
                        <button
                          key={index}
                          onClick={() => {}}
                          className="flex flex-col sm:flex-row items-center p-2 sm:p-4 text-center sm:text-left rounded-lg border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-colors group"
                        >
                          <IconComponent className="w-4 h-4 sm:w-5 sm:h-5 mb-1 sm:mb-0 sm:mr-3 text-blue-600 dark:text-blue-400 group-hover:text-blue-700 dark:group-hover:text-blue-300 flex-shrink-0" />
              ...
              <div className="flex-1 relative">
                ...
                <div className="absolute right-2 sm:right-3 top-1/2 transform -translate-y-1/2">
                  <Button
                    ...
                    size="icon"
                    disabled={true}
                    className="h-5 w-5 sm:h-6 sm:w-6 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-gray-600"
                  >
